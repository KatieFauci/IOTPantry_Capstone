...
#    Nov 09, 2020 12:28:14 AM EST  platform: Windows NT
...
def vp_start_gui():
    ...
    top = Toplevel1 (root)
    ShoppingList_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    ShoppingList_support.set_Tk_var()
    top = Toplevel1 (w)
    ShoppingList_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.frame_sl_main = tk.Frame(self.canvas_base)
        self.frame_sl_main.place(relx=0.0, rely=0.083, relheight=0.833
                , relwidth=1.0)
        self.frame_sl_main.configure(relief='groove')
        self.frame_sl_main.configure(borderwidth="2")
        self.frame_sl_main.configure(relief="groove")
        self.frame_sl_main.configure(background="#585670")
        self.frame_sl_main.configure(highlightbackground="#d9d9d9")
        self.frame_sl_main.configure(highlightcolor="black")

        self.button_sl_delete = tk.Button(self.frame_sl_main)
        self.button_sl_delete.place(relx=0.059, rely=0.068, height=24, width=47)
        self.button_sl_delete.configure(activebackground="#ececec")
        self.button_sl_delete.configure(activeforeground="#000000")
        self.button_sl_delete.configure(background="#af0101")
        self.button_sl_delete.configure(disabledforeground="#a3a3a3")
        self.button_sl_delete.configure(foreground="#000000")
        self.button_sl_delete.configure(highlightbackground="#d9d9d9")
        self.button_sl_delete.configure(highlightcolor="black")
        self.button_sl_delete.configure(pady="0")
        self.button_sl_delete.configure(text='''Delete''')

        self.label_sl_item = tk.Label(self.frame_sl_main)
        self.label_sl_item.place(relx=0.117, rely=0.156, height=34, width=198)
        self.label_sl_item.configure(activebackground="#f9f9f9")
        self.label_sl_item.configure(activeforeground="black")
        self.label_sl_item.configure(background="#d9d9d9")
        self.label_sl_item.configure(disabledforeground="#a3a3a3")
        self.label_sl_item.configure(foreground="#000000")
        self.label_sl_item.configure(highlightbackground="#d9d9d9")
        self.label_sl_item.configure(highlightcolor="black")
        self.label_sl_item.configure(text='''X''')

        self.Checkbutton2 = tk.Checkbutton(self.frame_sl_main)
        self.Checkbutton2.place(relx=0.059, rely=0.156, relheight=0.056
                , relwidth=0.061)
        self.Checkbutton2.configure(activebackground="#ececec")
        self.Checkbutton2.configure(activeforeground="#000000")
        self.Checkbutton2.configure(background="#585670")
        ...
        self.Checkbutton2.configure(variable=ShoppingList_support.che84)
