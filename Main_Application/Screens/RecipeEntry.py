...
#    Nov 29, 2020 01:31:31 AM EST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    RecipeEntry_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    RecipeEntry_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Frame1.place(relx=0.0, rely=0.083, relheight=0.833, relwidth=1.0)
        self.Frame1.configure(relief='groove')
        self.Frame1.configure(borderwidth="2")
        self.Frame1.configure(relief="groove")
        self.Frame1.configure(background="#585670")
        self.Frame1.configure(highlightbackground="#d9d9d9")
        self.Frame1.configure(highlightcolor="black")

        self.label_recEnt_title = tk.Label(self.Frame1)
        self.label_recEnt_title.place(relx=0.078, rely=0.08, height=30
                , width=350)
        self.label_recEnt_title.configure(activebackground="#f9f9f9")
        self.label_recEnt_title.configure(activeforeground="black")
        self.label_recEnt_title.configure(background="#939393")
        self.label_recEnt_title.configure(disabledforeground="#a3a3a3")
        self.label_recEnt_title.configure(foreground="#000000")
        self.label_recEnt_title.configure(highlightbackground="#d9d9d9")
        self.label_recEnt_title.configure(highlightcolor="black")
        self.label_recEnt_title.configure(text='''Title''')

        self.label_recEnt_time = tk.Label(self.Frame1)
        self.label_recEnt_time.place(relx=0.078, rely=0.16, height=30, width=50)
        self.label_recEnt_time.configure(activebackground="#f9f9f9")
        self.label_recEnt_time.configure(activeforeground="black")
        self.label_recEnt_time.configure(background="#939393")
        self.label_recEnt_time.configure(disabledforeground="#a3a3a3")
        self.label_recEnt_time.configure(foreground="#000000")
        self.label_recEnt_time.configure(highlightbackground="#d9d9d9")
        self.label_recEnt_time.configure(highlightcolor="black")
        self.label_recEnt_time.configure(text='''Time''')

        self.label_rec_ins = tk.Label(self.Frame1)
        self.label_rec_ins.place(relx=0.449, rely=0.28, height=21, width=149)
        self.label_rec_ins.configure(activebackground="#f9f9f9")
        self.label_rec_ins.configure(activeforeground="black")
        self.label_rec_ins.configure(background="#939393")
        self.label_rec_ins.configure(disabledforeground="#a3a3a3")
        self.label_rec_ins.configure(foreground="#000000")
        self.label_rec_ins.configure(highlightbackground="#d9d9d9")
        self.label_rec_ins.configure(highlightcolor="black")
        self.label_rec_ins.configure(text='''Instructions''')

        self.label_rec_ing = tk.Label(self.Frame1)
        self.label_rec_ing.place(relx=0.088, rely=0.28, height=21, width=150)
        self.label_rec_ing.configure(activebackground="#f9f9f9")
        self.label_rec_ing.configure(activeforeground="black")
        self.label_rec_ing.configure(background="#939393")
        self.label_rec_ing.configure(disabledforeground="#a3a3a3")
        self.label_rec_ing.configure(foreground="#000000")
        self.label_rec_ing.configure(highlightbackground="#d9d9d9")
        self.label_rec_ing.configure(highlightcolor="black")
        self.label_rec_ing.configure(text='''Ingredients''')

        self.button_rec_addin = tk.Button(self.Frame1)
        self.button_rec_addin.place(relx=0.146, rely=0.9, height=30, width=175)
        self.button_rec_addin.configure(activebackground="#ececec")
        self.button_rec_addin.configure(activeforeground="#000000")
        self.button_rec_addin.configure(background="#d9d9d9")
        self.button_rec_addin.configure(disabledforeground="#a3a3a3")
        self.button_rec_addin.configure(foreground="#000000")
        self.button_rec_addin.configure(highlightbackground="#d9d9d9")
        self.button_rec_addin.configure(highlightcolor="black")
        self.button_rec_addin.configure(pady="0")
        self.button_rec_addin.configure(text='''Add Ingredients To List''')

        self.label_steps = tk.Label(self.Frame1)
        self.label_steps.place(relx=0.449, rely=0.34, height=271, width=533)
        self.label_steps.configure(background="#ffffff")
        self.label_steps.configure(disabledforeground="#a3a3a3")
        self.label_steps.configure(foreground="#000000")
        self.label_steps.configure(justify='left')
        self.label_steps.configure(text='''Steps''')
        self.label_steps.configure(wraplength="400")

        self.label_ing_list = tk.Label(self.Frame1)
        self.label_ing_list.place(relx=0.088, rely=0.34, height=271, width=344)
        self.label_ing_list.configure(background="#ffffff")
        self.label_ing_list.configure(disabledforeground="#a3a3a3")
        self.label_ing_list.configure(foreground="#000000")
        self.label_ing_list.configure(justify='left')
        self.label_ing_list.configure(text='''Ingredients''')
        self.label_ing_list.configure(wraplength="400")
