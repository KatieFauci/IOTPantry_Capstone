...
#  Nov 23, 2020 12:00:52 AM EST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top45 {base} {
    ...
    frame $site_3_0.fra80 \
        -borderwidth 2 -relief groove -background #585670 -height 500 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 1024 
    vTcl:DefineAlias "$site_3_0.fra80" "frame_sl_main" vTcl:WidgetProc "Toplevel1" 1
    ...
    button $site_4_0.but81 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text {Clear List} 
    vTcl:DefineAlias "$site_4_0.but81" "button_sl_delete" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab83 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text X 
    vTcl:DefineAlias "$site_4_0.lab83" "label_sl_item" vTcl:WidgetProc "Toplevel1" 1
    checkbutton $site_4_0.che84 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #585670 -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -variable che84 
    vTcl:DefineAlias "$site_4_0.che84" "Checkbutton2" vTcl:WidgetProc "Toplevel1" 1
    place $site_4_0.but81 \
        -in $site_4_0 -x 0 -relx 0.059 -y 0 -rely 0.04 -width 127 -relwidth 0 \
        -height 34 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab83 \
        -in $site_4_0 -x 0 -relx 0.117 -y 0 -rely 0.156 -width 0 \
        -relwidth 0.194 -height 0 -relheight 0.068 -anchor nw \
        -bordermode ignore 
    place $site_4_0.che84 \
        -in $site_4_0 -x 0 -relx 0.059 -y 0 -rely 0.156 -width 0 \
