...
#    Nov 09, 2020 12:54:18 AM EST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.label_rec_ins.configure(cursor="fleur")
        ...
        self.listbox_rec_ing = tk.Listbox(self.Frame1)
        self.listbox_rec_ing.place(relx=0.088, rely=0.34, relheight=0.544
                , relwidth=0.316)
        self.listbox_rec_ing.configure(background="white")
        self.listbox_rec_ing.configure(cursor="fleur")
        self.listbox_rec_ing.configure(disabledforeground="#a3a3a3")
        self.listbox_rec_ing.configure(font="TkFixedFont")
        self.listbox_rec_ing.configure(foreground="#000000")

        self.Llistbox_rec_ins = tk.Listbox(self.Frame1)
        self.Llistbox_rec_ins.place(relx=0.449, rely=0.34, relheight=0.544
                , relwidth=0.512)
        self.Llistbox_rec_ins.configure(background="white")
        self.Llistbox_rec_ins.configure(disabledforeground="#a3a3a3")
        self.Llistbox_rec_ins.configure(font="TkFixedFont")
        self.Llistbox_rec_ins.configure(foreground="#000000")
