...
#  Nov 29, 2020 12:51:12 AM EST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top45 {base} {
    ...
    listbox $site_4_0.lis102 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -height 272 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -selectbackground blue -selectforeground white -width 324 
    ...
    label $site_4_0.lab46 \
        ...
        -foreground $vTcl(actual_gui_fg) -justify left -text Steps \
        -wraplength 400 
    vTcl:DefineAlias "$site_4_0.lab46" "label_steps" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_4_0.lab46 \
        ...
        -relwidth 0.521 -height 0 -relheight 0.542 -anchor nw \
        -bordermode ignore 
