...
#  Nov 09, 2020 12:54:16 AM EST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top45 {base} {
    ...
    frame $site_3_0.fra96 \
        -borderwidth 2 -relief groove -background #585670 -height 265 \
        -width 365 
    vTcl:DefineAlias "$site_3_0.fra96" "Frame1" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_4_0.lab97" "label_recEnt_title" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab98 \
        -background #939393 -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -text Time 
    vTcl:DefineAlias "$site_4_0.lab98" "label_recEnt_time" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab99 \
        -background #939393 -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -text Instructions 
    vTcl:DefineAlias "$site_4_0.lab99" "label_rec_ins" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab100 \
        -background #939393 -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -text Ingredients 
    vTcl:DefineAlias "$site_4_0.lab100" "label_rec_ing" vTcl:WidgetProc "Toplevel1" 1
    button $site_4_0.but101 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text {Add Ingredients To List} 
    vTcl:DefineAlias "$site_4_0.but101" "button_rec_addin" vTcl:WidgetProc "Toplevel1" 1
    listbox $site_4_0.lis102 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -height 272 -width 324 
    $site_4_0.lis102 configure -font "TkFixedFont"
    $site_4_0.lis102 insert end text
    vTcl:DefineAlias "$site_4_0.lis102" "listbox_rec_ing" vTcl:WidgetProc "Toplevel1" 1
    listbox $site_4_0.lis103 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -height 272 -width 524 
    $site_4_0.lis103 configure -font "TkFixedFont"
    $site_4_0.lis103 insert end text
    vTcl:DefineAlias "$site_4_0.lis103" "Llistbox_rec_ins" vTcl:WidgetProc "Toplevel1" 1
    place $site_4_0.lab97 \
        -in $site_4_0 -x 0 -relx 0.078 -y 0 -rely 0.08 -width 0 \
        -relwidth 0.342 -height 0 -relheight 0.06 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab98 \
        -in $site_4_0 -x 0 -relx 0.078 -y 0 -rely 0.16 -width 0 \
        -relwidth 0.049 -height 0 -relheight 0.06 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab99 \
        -in $site_4_0 -x 0 -relx 0.449 -y 0 -rely 0.28 -width 0 \
        -relwidth 0.146 -height 0 -relheight 0.042 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab100 \
        -in $site_4_0 -x 0 -relx 0.088 -y 0 -rely 0.28 -width 0 \
        -relwidth 0.146 -height 0 -relheight 0.042 -anchor nw \
        -bordermode ignore 
    place $site_4_0.but101 \
        -in $site_4_0 -x 0 -relx 0.146 -y 0 -rely 0.9 -width 175 -relwidth 0 \
        -height 30 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lis102 \
        -in $site_4_0 -x 0 -relx 0.088 -y 0 -rely 0.34 -width 0 \
        -relwidth 0.316 -height 0 -relheight 0.544 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lis103 \
        -in $site_4_0 -x 0 -relx 0.449 -y 0 -rely 0.34 -width 0 \
        -relwidth 0.512 -height 0 -relheight 0.544 -anchor nw \
        -bordermode ignore 
    ...
    place $site_3_0.fra96 \
        ...
        -relheight 0.833 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.can46 \
