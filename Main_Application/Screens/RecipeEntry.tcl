...
proc vTclWindow.top45 {base} {
    ...
    label $site_4_0.lab47 \
        -background #ffffff -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -justify left -text Ingredients \
        -wraplength 400 
    vTcl:DefineAlias "$site_4_0.lab47" "label_ing_list" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_4_0.lab47 \
        ...
        -relwidth 0.336 -height 0 -relheight 0.542 -anchor nw \
        -bordermode ignore 
