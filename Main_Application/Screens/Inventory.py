...
#    Nov 29, 2020 05:26:14 PM EST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1 = tk.Button(self.frame_invMain)
        self.Button1.place(relx=0.947, rely=0.889, height=40, width=45)
        ...
        self.Button2 = tk.Button(self.frame_invMain)
        self.Button2.place(relx=0.01, rely=0.889, height=40, width=45)
        ...
        self.button_clear_search = tk.Button(self.frame_inv_search)
        self.button_clear_search.place(relx=0.264, rely=0.3, height=24, width=76)

        self.button_clear_search.configure(activebackground="#ececec")
        self.button_clear_search.configure(activeforeground="#000000")
        self.button_clear_search.configure(background="#d9d9d9")
        self.button_clear_search.configure(disabledforeground="#a3a3a3")
        self.button_clear_search.configure(foreground="#000000")
        self.button_clear_search.configure(highlightbackground="#d9d9d9")
        self.button_clear_search.configure(highlightcolor="black")
        self.button_clear_search.configure(pady="0")
        self.button_clear_search.configure(text='''Clear Search''')
