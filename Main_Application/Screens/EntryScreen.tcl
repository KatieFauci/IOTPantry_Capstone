...
#  Nov 18, 2020 11:50:19 PM EST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top45 {base} {
    ...
    frame $site_3_0.fra45 \
        ...
        -highlightcolor black -width 266 
    ...
    vTcl:DefineAlias "$site_4_0.ent46" "entry_code" vTcl:WidgetProc "Toplevel1" 1
    entry $site_4_0.ent47 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 10 
    vTcl:DefineAlias "$site_4_0.ent47" "Entry_prod_name" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_4_0.lab48" "label_code" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab49 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {Product Name} 
    vTcl:DefineAlias "$site_4_0.lab49" "label_prodName" vTcl:WidgetProc "Toplevel1" 1
    entry $site_4_0.ent50 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 104 
    vTcl:DefineAlias "$site_4_0.ent50" "Entry_foodGroup" vTcl:WidgetProc "Toplevel1" 1
    entry $site_4_0.ent51 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground blue -width 10 
    vTcl:DefineAlias "$site_4_0.ent51" "Entry_expd" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab52 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {Food Group} 
    vTcl:DefineAlias "$site_4_0.lab52" "Label_foodGroup" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_4_0.lab53" "Label_enterexp" vTcl:WidgetProc "Toplevel1" 1
    entry $site_4_0.ent54 \
        ...
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 10 
    vTcl:DefineAlias "$site_4_0.ent54" "entry_numItems" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab56 \
        -activebackground #f9f9f9 -activeforeground black \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text Quantity 
    vTcl:DefineAlias "$site_4_0.lab56" "label_numitems" vTcl:WidgetProc "Toplevel1" 1
    button $site_4_0.but57 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text {Add to Inventory} 
    vTcl:DefineAlias "$site_4_0.but57" "button_add" vTcl:WidgetProc "Toplevel1" 1
    button $site_4_0.but45 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #9e9e9e -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text X 
    vTcl:DefineAlias "$site_4_0.but45" "Button1" vTcl:WidgetProc "Toplevel1" 1
    place $site_4_0.ent46 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.152 -width 200 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.ent47 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.278 -width 200 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab48 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.101 -width 0 \
        -relwidth 0.806 -height 0 -relheight 0.053 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab49 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.228 -width 0 \
        -relwidth 0.806 -height 0 -relheight 0.053 -anchor nw \
        -bordermode ignore 
    place $site_4_0.ent50 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.405 -width 200 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.ent51 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.532 -width 200 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab52 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.354 -width 0 \
        -relwidth 0.806 -height 0 -relheight 0.053 -anchor nw \
        -bordermode ignore 
    place $site_4_0.lab53 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.481 -width 0 \
        -relwidth 0.806 -height 0 -relheight 0.053 -anchor nw \
        -bordermode ignore 
    place $site_4_0.ent54 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.658 -width 200 \
        -relwidth 0 -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.lab56 \
        -in $site_4_0 -x 0 -relx 0.101 -y 0 -rely 0.608 -width 0 \
        -relwidth 0.806 -height 0 -relheight 0.053 -anchor nw \
        -bordermode ignore 
    place $site_4_0.but57 \
        -in $site_4_0 -x 0 -relx 0.202 -y 0 -rely 0.81 -width 150 -relwidth 0 \
        -height 30 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.but45 \
        -in $site_4_0 -x 0 -relx 0.863 -y 0 -rely 0.025 -width 25 -relwidth 0 \
    ...
    place $site_3_0.fra45 \
        -in $site_3_0 -x 0 -relx 0.381 -y 0 -rely 0.15 -width 0 \
        -relwidth 0.243 -height 0 -relheight 0.658 -anchor nw \
        -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
