...
#  Nov 12, 2020 08:50:27 PM EST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top45 {base} {
    ...
    label $site_4_0.lab48 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -justify left \
        -text Barcode 
    ...
    entry $site_4_0.ent51 \
        ...
        -selectforeground SystemHighlightText -width 10 
